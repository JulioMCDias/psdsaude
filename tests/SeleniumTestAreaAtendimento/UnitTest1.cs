...
namespace SeleniumTestAreaAtendimento
{
    [TestClass]
    public class AreaDeAtendimento
    {
        ...
        public void TheAreaDeAtendimentoTest()
        {
            ...
            driver.FindElement(By.Name("nome_paciente")).Clear();
            driver.FindElement(By.Name("nome_paciente")).SendKeys("teste");
            driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='Nome do paciente:'])[1]/following::div[1]")).Click();
            ...
            driver.FindElement(By.Name("data_nasc")).SendKeys("2018-11-14");
            driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='Data de Nascimento:'])[1]/following::input[2]")).Click();
            driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='Sobre Nós'])[1]/following::li[1]")).Click();
